    ...
    if (!class_exists('Inisev\Subs\InisevPlugPromo')) {
      ...
      class InisevPlugPromo {
        ...
        function __construct($file, $slug, $byName, $menu) {
          ...
          // Plugin assets
          $this->url = trailingslashit(plugins_url(null, $file)) . 'modules/promotion/assets/';
        ...
        public function addScriptsAndStyles() {
          ...
          if (defined('insPP_renderScripts')) {
            ...
            // Load styles & script
            wp_enqueue_script('inisev-promotion-script', ($this->url . 'script.min.js'), [], filemtime(__DIR__ . '/assets/script.min.js'));
            wp_enqueue_style('inisev-promotion-style', ($this->url . 'style.min.css'), [], filemtime(__DIR__ . '/assets/style.min.css'));
